...
var ColoredTagsPlugin = class extends import_obsidian.Plugin {
  ...
  getColors(input, palette) {
    ...
    if (input.toLowerCase().startsWith("intranda")) {
      const background2 = "lch(55 121.43 42.57 / 0.32)";
      const color2 = "lch(40 100.22 43.45)";
    ...
    if (input.toLowerCase().startsWith("done") || input.toLowerCase().startsWith("erledigt")) {
      const background2 = "lch(92 0 124)";
      const color2 = "lch(70 0 124)";
      return { background: background2, color: color2 };
    }
